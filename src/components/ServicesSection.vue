<template>
  <section class="py-24 bg-white overflow-hidden" id="services">
    <div class="container mx-auto px-4">
      
      <!-- Section Header -->
      <div class="text-center mb-20 relative z-40" data-aos="fade-up">
        <h2 class="text-sm font-bold tracking-widest text-orange-500 uppercase mb-3">Sản phẩm chủ lực</h2>
        <h3 class="text-3xl md:text-5xl font-bold text-slate-900">May - In - Thêu Đồng Phục</h3>
        <p class="mt-4 text-gray-500 max-w-2xl mx-auto">Chất lượng vải cao cấp, đường may tinh tế, thiết kế theo yêu cầu.</p>
      </div>

      <div v-if="products.length > 0" class="flex flex-col lg:flex-row-reverse gap-16 items-center relative">
        ...
        <div class="w-full lg:w-1/2 pt-12 lg:pt-0" data-aos="fade-left">
          <div class="space-y-6">
            ...
            >
              ...
              <!-- Link to detail in list item as well -->
...
onMounted(async () => {
  products.value = await getProductsByCategory('uniform')
})
</script>
