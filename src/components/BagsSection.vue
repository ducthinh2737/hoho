...
onMounted(async () => {
  products.value = await getProductsByCategory('bag')
})
</script>
  ...
  <section class="py-24 bg-slate-50">
    <div class="container mx-auto px-4 relative">
      <div class="text-center mb-20 relative z-40" data-aos="fade-up">
        <h2 class="text-sm font-bold tracking-widest text-orange-500 uppercase mb-3">Sản phẩm bao bì</h2>
        <h3 class="text-3xl md:text-5xl font-bold text-slate-900">Bao Bì & Túi Giấy</h3>
        <p class="mt-4 text-gray-500 max-w-2xl mx-auto">Giải pháp đóng gói toàn diện, nâng tầm giá trị sản phẩm của bạn.</p>
      </div>

      <div v-if="products.length > 0" class="flex flex-col lg:flex-row-reverse items-center gap-16 relative mb-12">
        
        <!-- Left Column: Product List -->
        <div class="w-full lg:w-1/2 space-y-8 mt-12 lg:mt-0" data-aos="fade-left">
          <div class="space-y-6">
            <div 
        ...
        <!-- Right Column: Image (Visually Left) -->
